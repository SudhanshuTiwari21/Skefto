...
import { LINKS, SECTORS, SECTORS_INTRO } from "@/lib/risk-content";
import { Button, Container, SectionHeading } from "@/components/ui";
import { Icon, type IconName } from "@/components/icons";
import { SkeftoGeoMark } from "@/components/skefto-geo-icons";

export function RiskSectorTabs() {
    ...
    <section id="sectors" className="scroll-mt-20 bg-ink-950 py-16 text-white sm:py-20">
      <Container>
        <SectionHeading
          ...
          title="Risk management that understands your regulatory environment"
              ...
              >
                ...
                <span>
                  ...
                  <span className={`mt-0.5 block text-[11px] font-medium ${i === active ? "text-ink-500" : "text-ink-400"}`}>
                    {s.id === "local-government" ? "Councils & shires" : s.id === "state-government" ? "Agencies" : "Regulated sector"}
                  </span>
                </span>
              </button>
            );
