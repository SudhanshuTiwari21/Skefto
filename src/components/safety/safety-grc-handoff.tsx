        ...
        <div className="grid items-center gap-8 rounded-3xl border border-ink-900/8 bg-white p-8 shadow-soft lg:grid-cols-[1.2fr_auto] lg:gap-12 lg:p-10">
          <div>
            ...
            <h2 className="mt-3 font-display text-2xl font-bold tracking-tight text-ink-900 sm:text-3xl">
              Safety, risk and compliance on one connected platform
            </h2>
            <p className="mt-4 max-w-2xl text-pretty text-sm leading-7 text-ink-600 sm:text-base">
              Workplace hazards should feed enterprise risk. Incidents should update controls.
              Safety obligations should sit beside your compliance register. Skefto keeps that
              loop intact so boards see WHS and organisational risk together.
            </p>
            <div className="mt-5 flex flex-wrap gap-x-5 gap-y-2">
              ...
              >
                Explore risk management software
          ...
          <div className="flex flex-col gap-3 sm:min-w-[220px]">
            <BeamButton href={RISK_CANONICAL_PATH} fill="brand" size="lg">
              Risk software
            </BeamButton>
            <Link
              href={LINKS.demo}
